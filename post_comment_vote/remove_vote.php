...
include('../jwt.php');
    ...
    $sql = "DELETE FROM post_comment_vote WHERE post_id='$post_id' AND user_id='$user_id' AND cmt_id='$cmt_id'";
    $rl = mysqli_query($conn, $sql);
    
    $sqlCheck = "SELECT vote_id FROM post_comment_vote WHERE post_id='$post_id' AND user_id='$user_id' AND cmt_id='$cmt_id'";
