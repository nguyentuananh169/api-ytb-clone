<?php 
	...
	include('../library.php');
    	...
    	$sqlUpdate = "UPDATE post_comments SET cmt_content='$content', cmt_edited='1', cmt_updated_at='$timestamp' WHERE post_id='$post_id' AND cmt_id='$cmt_id' AND user_id='$user_id'";
