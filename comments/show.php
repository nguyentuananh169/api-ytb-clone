<?php 
	...
	$sql2 = "SELECT * FROM comments INNER JOIN users ON comments.user_id = users.user_id WHERE comments.cmt_parent_id='$parent_id' AND comments.video_id='$video_id' ORDER BY cmt_pin DESC, $order_by $order_type $sql_limit";
